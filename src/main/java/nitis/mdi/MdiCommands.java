...
public class MdiCommands implements ModInitializer {
    ...
    private int setAbsorbHealth(EntitySelector entity, float amount, ServerCommandSource serverCommandSource){
        try{
            ...
            minecraftClient.inGameHud.addChatMessage(MessageType.SYSTEM, new TranslatableText("command.mdi.get_absorb", livingEntity.getAbsorptionAmount()), Util.NIL_UUID);
            return 1;
        }catch(Exception e){
            return 0;
        }
    ...
    private int setHealth(EntitySelector entity, float amount, ServerCommandSource serverCommandSource){
        try{
            ...
            minecraftClient.inGameHud.addChatMessage(MessageType.SYSTEM, new TranslatableText("command.mdi.get_health", livingEntity.getHealth()), Util.NIL_UUID);
            return 1;
        }catch(Exception e){
            return 0;
        }
